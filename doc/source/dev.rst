...
Contributing
------------
.. _github repository: http://github.com/alisaifee/nosedbreport

The source is maintained in a `github repository`_. Feel free to fork it to modify/extend the plugin.
